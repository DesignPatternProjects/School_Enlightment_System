...
public class JFrame_Library_IssueBook extends JFrame {
	static JFrame_Library_IssueBook frame;
	 ...
	 * Create the frame.
	 */
	public JFrame_Library_IssueBook(String username) {
	...
	public void initComponents() {
		...
		JLabel lblStudentContact = new JLabel("Student Email:");
	...
	public void showData() {
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(Library_IssueBook_State.checkBook(book_id)){
			
			int i=Library_IssueBook_State.save(book_id, student_id, student_name, email);
			if(i>0){
				JOptionPane.showMessageDialog(JFrame_Library_IssueBook.this,"Book issued successfully!");
				//LibrarianSuccess.main(new String[]{});
				//frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(JFrame_Library_IssueBook.this,"Sorry, unable to issue!");
			}//end of save if-else
			
			}else{
				JOptionPane.showMessageDialog(JFrame_Library_IssueBook.this,"Sorry, Callno doesn't exist!");
